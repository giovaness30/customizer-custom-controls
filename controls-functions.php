...
if ( ! function_exists( 'skyrocket_scripts_styles' ) ) {
	function skyrocket_scripts_styles() {
		...
		wp_register_style( 'fontawesome', trailingslashit( get_template_directory_uri() ) . '/controls-custom/css/fontawesome-all.min.css' , array(), '5.8.2', 'all' );
...
if ( ! function_exists( 'skyrocket_customizer_preview_scripts' ) ) {
	function skyrocket_customizer_preview_scripts() {
		wp_enqueue_script( 'skyrocket-customizer-preview', trailingslashit( get_template_directory_uri() ) . '/controls-custom/js/customizer-preview.js', array( 'customize-preview', 'jquery' ) );
	}
}
...
*/
include_once trailingslashit( dirname(__FILE__) ) . '/controls-custom/inc/customizer.php';

//Adiciona style
function load_stylesheets()
{
	wp_register_style('stylesheet', get_template_directory_uri() . '/controls-functions/style.css', '', 1, 'all');
